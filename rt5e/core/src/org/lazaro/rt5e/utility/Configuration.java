...
public class Configuration {
    ...
    public Configuration(File file) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            ...
            } else if (line.startsWith("ARRAY") && line.contains("[")
                    && line.contains("]")) {
                String key = line.substring(line.indexOf(" ") + 1, line
                        .indexOf("["));
    ...
    public Object[] getArray(String key) {
        ...
        if (obj instanceof Object[])
            return (Object[]) obj;
        throw new RuntimeException("Requested variable, " + key
                + ", is not an array or isn't available!");
    }
    ...
    public int getInt(String key) {
        ...
        throw new RuntimeException("Requested variable, " + key
                + ", is not an integer or isn't available!");
    }
    ...
    public int[] getIntArray(String key, int defaultValue) {
        ...
        if (obj instanceof Object[]) {
            ...
            return (int[]) obj;
        throw new RuntimeException("Requested variable, " + key
                + ", is not an integer array or isn't available!");
    }
    ...
    public String getString(String key) {
        ...
        if (obj instanceof String || obj instanceof Integer)
            return obj.toString();
        throw new RuntimeException("Request variable, " + key
                + ", is not a string type or isn't available!");
    }
