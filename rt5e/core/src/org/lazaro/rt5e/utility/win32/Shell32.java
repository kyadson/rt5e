...
/**
 * Mapping for w32 Shell API. Note that the C header "shellapi.h" includes
...
public interface Shell32 extends W32API {
    ...
    // Tools
    int CSIDL_ADMINTOOLS = 0x0030; // <user name>\Start
    ...
    int CSIDL_COMPUTERSNEARME = 0x003d; // Computers Near Me (computered from
    ...
    int CSIDL_LOCAL_APPDATA = 0x001c; // <user name>\Local Settings\Applicaiton
    int CSIDL_PERSONAL = 0x0005; // My Documents
    int CSIDL_MYDOCUMENTS = CSIDL_PERSONAL; // Personal was just a silly name
    // for My Documents
    ...
    int CSIDL_PROGRAM_FILES_COMMONX86 = 0x002c; // x86 Program Files\Common on
